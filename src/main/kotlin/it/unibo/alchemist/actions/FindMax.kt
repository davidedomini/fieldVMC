...
class FindMax<T, P : Position<P>>(
    ...
    override fun execute() {
        ...
        if ((children.isEmpty() && parent == null) ||
            // if I am leaf and root I should spawn anyway
            (children.isEmpty() && current.action == FORWARD && parent != null && parent.second.currentClock().action == FORWARD)
        ) { // I'm leaf and I think I'm max
            ...
            val maxChildren =
                children
                    .maxBy { (n, _) -> n.getConcentration(SimpleMolecule("max-leaf-res")) as Double }
                    .first
